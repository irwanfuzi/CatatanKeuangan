...
class _MainShellNavigationState extends State<MainShellNavigation> {
  int _currentIndex = 3; // Default ke Tab Profil untuk testing
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        index: _currentIndex,
        children: [
          _DummyTabScreen(title: 'Beranda Kas', icon: Icons.grid_view_rounded),
          _DummyTabScreen(title: 'Analisis Keuangan', icon: Icons.bar_chart_rounded),
          _DummyTabScreen(title: 'Riwayat Transaksi', icon: Icons.history_rounded),
          ProfilScreen(
