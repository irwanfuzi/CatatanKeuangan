...
@override
State createState() => _MyKasAppState();
}

class _MyKasAppState extends State {
// STATE TEMA GLOBAL
...
@override
State createState() => _MainShellNavigationState();
}

class _MainShellNavigationState extends State {
